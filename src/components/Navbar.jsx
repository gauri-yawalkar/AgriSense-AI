    ...
    <nav className="navbar">
      <div className="container nav-container">
        <NavLink to="/" className="nav-brand">
          ...
          <span>AgriSense <strong>AI</strong></span>
        </NavLink>
        ...
        <div className={`nav-links ${isOpen ? 'open' : ''}`}>
          ...
          <NavLink to="/disease-detection" onClick={() => setIsOpen(false)}>Disease Detection</NavLink>
          ...
          <div className="social-links-container">
            <a href="https://github.com/gauri-yawalkar/AgriSense-AI" target="_blank" rel="noopener noreferrer" className="social-icon" aria-label="GitHub">
