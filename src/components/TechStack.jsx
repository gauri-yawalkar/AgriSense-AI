      ...
      <div className="container">
        ...
        <div className="stack-grid">
          ...
          <div className="glass-panel stack-category">
            ...
            <div className="stack-items">
              <span className="stack-badge">Raspberry Pi OS (Linux)</span>
              <span className="stack-badge">Python 3</span>
              <span className="stack-badge">OpenCV</span>
              <span className="stack-badge">Flask / Streamlit</span>
              <span className="stack-badge">Plotly (Data Viz)</span>
            </div>
          </div>
