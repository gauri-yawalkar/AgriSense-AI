...
def plot_and_save_history(history, output_dir="."):
    ...
    print(f"Saved training curves and CSV logs to {os.path.abspath(output_dir)}")
...
def train_model(data_dir, epochs=15, batch_size=32, lr=0.001):
    ...
    with open('potato_class_mapping.json', 'w') as f:
        json.dump(class_mapping, f, indent=4)

    print("Loading EfficientNet-B0 pre-trained model...")
    ...
    for epoch in range(epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val' and epoch_acc > best_acc:
                best_acc = epoch_acc
                torch.save(model.state_dict(), 'best_potato_effnet.pth')
        ...
        # Calculate and print ETA after the first epoch
    ...
    # Plot and save everything at the end
    print("\nGenerating training logs and graphs...")
    plot_and_save_history(history)

if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Train EfficientNet-B0 on Potato Dataset")
    default_data_dir = r"c:\T4T\leaf disease\indian-leaf-disease\raw_datasets\potato_split"
