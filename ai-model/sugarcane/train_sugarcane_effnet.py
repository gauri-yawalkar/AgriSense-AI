...
def train_model(data_dir, epochs=15, batch_size=32, lr=0.001):
    ...
    with open(os.path.join(OUTPUT_DIR, 'sugarcane_class_mapping.json'), 'w') as f:
    ...
    for epoch in range(epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val' and epoch_acc > best_acc:
                best_acc = epoch_acc
                torch.save(model.state_dict(), os.path.join(OUTPUT_DIR, 'best_sugarcane_effnet.pth'))
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Train EfficientNet-B0 on Sugarcane Dataset")
    default_data_dir = r"c:\T4T\leaf disease\indian-leaf-disease\raw_datasets\sugarcane_split"
